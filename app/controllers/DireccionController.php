...
require_once $_SERVER['DOCUMENT_ROOT'] . '/ibmjlmoconfig/database.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/ibmjlmoapp/models/Direccion.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/ibmjlmoapp/models/Persona.php';
